/*
* Software: Jogador 1 do Jogo da Marmota
*
...
*
* Descrição:
*   Este código implementa as funcionalidades do lado do jogador 1 do jogo da marmota
...
//  pino dos leds
unsigned int pinoLed[4] = {2,4,3,2};
...
//  jogo tradicional com 1 jogadores
